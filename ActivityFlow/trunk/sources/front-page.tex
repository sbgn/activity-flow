...
Disclaimer: This is a working draft of the SBGN Activity Flow language Level~1 specification.  It is not a normative document.
\end{minipage}}
...
\normalsize
\begin{minipage}{5in}
  \emph{To discuss any aspect of SBGN, please send your messages to the mailing list \mailto{sbgn-discuss@sbgn.org}.  To get subscribed to the mailing list or to contact us directly, please write to \mailto{sbgn-team@sbgn.org}. Bug reports and specific comments about the specification should be entered in the issue tracker \url{http://sourceforge.net/tracker/?group_id=178553&atid=1082245}.}
\end{minipage}
