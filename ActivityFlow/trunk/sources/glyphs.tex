...
\glyph{Containers} are SBGN constructions that contain one or several other SBGN constructs.  Right now, \glyph{compartment} is the only container node in \SBGNAFLone.
