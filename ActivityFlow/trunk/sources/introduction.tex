...
This document defines the \emph{\AF{}} visual language of SBGN.  As explained more fully in~\sect{languages}, \AFs are one of three views of a model offered by SBGN.  It is the product of many hours of discussion and development by many individuals and groups.  In the following sections, we describe the background, motivations, and context of \AFs.
