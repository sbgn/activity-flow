...
\glyphSboTerm SBO:
 ...
 \glyphTarget Any \glyph{biological activity node} or \glyph{phenotype} (\sect{af:ANs}).
...
\begin{figure}[H]
  ...
  \caption{An exmaple of \glyph{positive influence} from a \glyph{perturbation} to the to the nuclear hormone receptor PPAR dealta.}
  \label{fig:af:exPI}
\end{figure}