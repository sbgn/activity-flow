...
The text that appears as the \glyph{unit of information} decorating a Container Node (CN) must, in most cases, be prefixed with a controlled vocabulary term indicating the type of information being expressed.
