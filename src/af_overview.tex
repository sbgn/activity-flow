...
\begin{table}[bh]
  ...
  \begin{tabular}{@{}llP{2.4in}P{1.6in}@{}}
    ...
    Auxiliary units
    & AU
    & A decorating glyph added to the BA, compartment or submap to provide additional information about the node, such as the property where the activity originates, in the case of a BA
    & Unit of information or submap terminal  \\[1.6em]
