...
%\begin{figure}[H]
%  \centering
%  \includegraphics[scale = 0.4]{images/build/compartment-cell.png}
% \includegraphics[scale = 0.4]{images/build/compartment-cell-wrong.png}
...
%\begin{figure}[H]
%  \centering
%  \includegraphics[scale = 0.4]{images/build/compartment-3comp.png}
