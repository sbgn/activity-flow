...
standardise the graphical/visual representation of biochemical and
...
\label{sec:structure}
\chap{af:glyphs} provides a catalogue of the graphical symbols available for representing entities in \AFs. In \chap{af:grammar} beginning on page~\pageref{chp:af:grammar}, we describe the rules for combining these glyphs into a legal SBGN \AFm, and in \chap{af:layout} beginning on page~\pageref{chp:af:layout}, we describe requirements and guidelines for the way that \AFms are visually organised.
