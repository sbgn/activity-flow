...
\jibtitle{Systems Biology Graphical Notation:\\Activity Flow language Level~1 Version~1.3}
...
\jibauthor{Hasan Balci\iref{hasan},
Adrien Rougny\iref{adrien},
           Luiz Ladeira\iref{luiz},
           Huaiyu Mi\iref{huaiyu},
           Falk Schreiber\iref[,]{falk1}\iref{falk2},
           ...
           Rupert Overall\iref{rupert},
           Tobias Czauderna\iref{tobias},
           Augustin Luna\iref[,]{hasan}\iref{augustin2}\textsuperscript{,}\jibauthorfootnote{\textdagger}{To whom correspondence should be addressed. Email: \email{sbgn-editors@googlegroups.com}}
}

\addjibinstitution{hasan}{Computational Biology Branch, National Library of Medicine, NIH, Bethesda, Maryland 20892, USA}
\addjibinstitution{adrien}{Luxembourg Centre for Systems Biomedicine, University of Luxembourg, 6 Avenue du Swing, L-4367 Belvaux, Luxembourg}
\addjibinstitution{luiz}{Biomechanics Research Unit, GIGA Institute, University of Liège, Liège, Belgium}
\addjibinstitution{huaiyu}{Division of Biostatistics, Department of Population and Public Health Sciences, Keck School of Medicine, University of Southern California, Los Angeles, CA 90033, USA}
\addjibinstitution{falk1}{Department of Computer and Information Science, University of Konstanz, Konstanz, Germany}
\addjibinstitution{falk2}{Faculty of Information Technology, Monash University, Melbourne, Australia}
\addjibinstitution{stuart}{Novo Nordisk A/S, Research and Development, Novo Nordisk Park 1, 2760 Måløv, Denmark}
...
\addjibinstitution{anatoly}{InSysBio UK LTD, Edinburgh, UK}
\addjibinstitution{alice}{Freelance IT Consultant, UK}
\addjibinstitution{rupert}{Humboldt University, Germany}
\addjibinstitution{tobias}{Faculty of Applied Computer Sciences and Biosciences, University of Applied Sciences Mittweida, Mittweida, Germany}
\addjibinstitution{augustin2}{Developmental Therapeutics Branch, Center for Cancer Research, National Cancer Institute, NIH, Bethesda, MD 20892, USA}
...
\abstract{
The Systems Biology Graphical Notation (SBGN) is a global, community-driven initiative that provides standardised visual languages for depicting biological pathways and networks. Its purpose is to deliver clear, consistent diagrams that support accurate communication and knowledge exchange across research communities, industry, and other stakeholders in systems biology. SBGN comprises three complementary languages, Process Description (PD), Entity Relationship (ER), and Activity Flow (AF), each capturing distinct facets of biological and biochemical systems at varying levels of detail. The AF language depicts the activities of biological entities and their mutual influences, focusing on performed functions rather than the mechanistic or relational detail emphasised in PD and ER. AF includes activity nodes (e.g., biological activities such as kinase or binding, and phenotypes) and structural elements (e.g., compartments, submaps, tags), with edges representing the influence relationships between activities (e.g., positive and negative influence).  AF aligns closely with the style of signaling pathway diagrams found in biological literature, while providing enhanced semantic precision for capturing and communicating biological knowledge. Level 1 Version 1.3 introduces several improvements over Level 1 Version 1.2, including refined document organization and terminology, clearer and updated specification content, and revised figures and rules to strengthen consistency and interpretability throughout the language.
}
...
% format with the \emph{includegraphics}_command. Other graphics formats like gif,
...
% \emph{includegraphics}_command (see key \emph{bb} in Fig.~\ref{fig:jpeg_ex}). The
...
% {jpeg}-files by using the \emph{includegraphics}_command. Another possibility is
