...
\newcommand{\sbgndate}{05 March, 2009}
...
\newcommand{\SBGNAFLone}{SBGN \AF Level~1\xspace}
...
\newcommand{\stkeurl}     {\url{http://stke.sciencemag.org/cm/stkecm;CMP_14987}\xspace}
...
% Below code for sbgn logo is not used, instead we provide link for logo in front-page.tex
% ----------------------------------------------------------------
% SBGN logo.
% ----------------------------------------------------------------
