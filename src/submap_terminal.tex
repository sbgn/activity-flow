...
It is a named handle, or reference, to both an \glyph{AN} (\sect{af:ANs}) or \glyph{compartment} (\sect{compartment}) of the map, and a \glyph{tag} (\sect{tag}) of the map the \glyph{submap} glyph refers to.
